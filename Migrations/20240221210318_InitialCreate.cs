    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "joedirt@thegunshow.net", "Joe", "Dirt" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, 2, "https://www.paragoncasinoresort.com/wp-content/uploads/2021/01/rv-park-hero.jpg", "Cousin Eddy's Fun Town" },
                    { 3, 3, "https://static.wikia.nocookie.net/flinstones/images/1/16/Bedrock_in_The_Flintstones_and_WWE_-_StoneAge_SmackDown%21.png/revision/latest?cb=20200614065155", "Bedrock" },
                    { 4, 4, "https://cdn.europosters.eu/image/750/posters/paradise-hammock-i8013.jpg", "Margaritaville" },
                    { 5, 1, "https://i.dailymail.co.uk/i/pix/2011/05/26/article-1391089-0C47717600000578-155_1024x615_large.jpg", "Mountain View" },
                    { 6, 4, "https://worth-seeing.com/wp-content/uploads/2016/11/Monte-Piana.jpg", "Sky Town" }
                });

            migrationBuilder.InsertData(
                table: "Reservations",
                columns: new[] { "Id", "CampsiteId", "CheckinDate", "CheckoutDate", "UserProfileId" },
                values: new object[] { 1, 2, new DateTime(2024, 3, 11, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 3, 14, 0, 0, 0, 0, DateTimeKind.Unspecified), 1 });
